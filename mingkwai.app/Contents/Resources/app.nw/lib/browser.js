...
(function() {
  var APPLESCRIPT, CHR, CND, D, D$, LINESETTER, MKTS, NW, after, alert, app, badge, bindings, build_menu, debug, demo_count, echo, help, immediately, info, keycodes, log, njs_fs, njs_path, on_file_menu_what_you_should_know_C, rpr, sleep, splash_win, step, suspend, urge, warn, whisper, win, ƒ,
    __slice = [].slice;
