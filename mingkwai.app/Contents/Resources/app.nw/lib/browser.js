...
(function() {
  var APPLESCRIPT, CHR, CND, D, D$, LINESETTER, MKTS, NW, after, alert, app, badge, bindings, build_menu, debug, demo_count, echo, help, immediately, info, keycodes, log, matter, njs_fs, njs_path, on_file_menu_what_you_should_know_C, rpr, sleep, splash_info, splash_win, step, suspend, urge, warn, whisper, win, ƒ, _ref,
    __slice = [].slice;
