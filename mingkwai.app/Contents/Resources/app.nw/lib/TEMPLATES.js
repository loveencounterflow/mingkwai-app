...
(function() {
  var ARTBOARD, BOTTOMMARGIN, BOX, BUTTON, CELL, CHASE, CHR, CND, COLUMN, CSS, GALLEY, GAP, HBOX, HGAP, HRIBBON, JS, LEFTMARGIN, MARGIN, OVERLAY, PAGE, PAPER, RIBBON, RIGHTMARGIN, ROW, STYLUS, TEACUP, TOOL, TOPMARGIN, VBOX, VGAP, VRIBBON, XHGAP, ZOOMER, alert, badge, debug, help, info, log, name_, njs_fs, njs_path, rpr, urge, warn, whisper, _STYLUS,
    __slice = [].slice;
  ...
  ROW = new_tag(function() {
    var p;
    p = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return TAG.apply(null, ['row'].concat(__slice.call(p)));
  });

  CELL = new_tag(function() {
    var p;
    p = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return TAG.apply(null, ['cell'].concat(__slice.call(p)));
  });
  ...
  MARGIN = new_tag(function() {
    var p;
    p = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return TAG.apply(null, ['margin'].concat(__slice.call(p)));
  });
          ...
          return BODY(function() {
            return CHASE(function() {
              return COLUMN(function() {
                var idx, _i, _results;
                _results = [];
                for (idx = _i = 0; _i < 90; idx = ++_i) {
                  _results.push(DIV("" + idx));
                }
                return _results;
              });
            });
                  ...
                  _results.push(PAGE(function() {
                    ...
                    return CHASE(function() {
                      ...
                      BOX('.horizontal.columns-3', function() {
                        ...
                        COLUMN(function() {
                          var idx, _j, _results1;
                          if (page_nr === 1) {
                            _results1 = [];
                            for (idx = _j = 0; _j < 70; idx = ++_j) {
                              _results1.push(DIV('', "" + idx));
                            }
                            return _results1;
                          }
                        });
        ...
        return HTML(function() {
          ...
          return BODY(function() {
            return ARTBOARD('.pages', function() {
              return ZOOMER(function() {
                return DIV({
                  style: "display:table;width:200mm;height:250mm;"
                }, function() {
                  TR(function() {
                    TD('.margin-left', {
