...
(function() {
  var ARTBOARD, BOX, BOXER, BUTTON, CND, COLUMN, CORK, CSS, GALLEY, GRIP, HBOX, HGAP, HRIBBON, JS, LINE, OUTER, OVERLAY, PAGE, PANEL, PAPER, RIBBON, TABLETOP, TEACUP, TOOL, VBOX, VGAP, VRIBBON, WRAP, XHGAP, ZOOMER, alert, badge, debug, help, info, log, name_, njs_fs, njs_path, rpr, urge, warn, whisper,
    __slice = [].slice;
