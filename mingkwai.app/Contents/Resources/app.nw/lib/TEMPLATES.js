...
(function() {
  var ARTBOARD, BOX, BOXER, CND, COLUMN, CORK, CSS, GALLEY, GRIP, HGAP, JS, LINE, OUTER, OVERLAY, PAGE, PANEL, PAPER, RIBBON, TABLETOP, TEACUP, TOOL, VGAP, WRAP, XHGAP, alert, badge, debug, help, info, log, name_, njs_fs, njs_path, rpr, urge, warn, whisper,
    __slice = [].slice;
